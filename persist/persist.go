...
const (
	...
	NeverPersist = "disabled"

	// NotPersisting indicates that the persistence store requires
	// more delegations to unlock, and isn't currently persisting
	// the store.
	NotPersisting = "inactive"

	// NowPersisting indicates that the persistence store is
	// actively persisting delegations.
	NowPersisting = "active"
)
